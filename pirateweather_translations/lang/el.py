...
template = {
    ...
    "possible-medium-sleet": "πιθανό χιονόνερο",
    "possible-heavy-sleet": "πιθανό ισχυρό χιονόνερο",
    "possible-medium-snow": "πιθανή χιονόπτωση",
    "possible-heavy-snow": "πιθανή ισχυρή χιονόπτωση",
    "possible-very-light-freezing-rain": "πιθανό παγερό ψιλόβροχο",
    ...
    "fog": "ομίχλη",
    "very-light-clouds": "κυρίως αίθριος",
